...
var sumDays = function(timeseries, dayStart, dayEnd, moment) {
  var sum = 0;
  var i = 0;
...
exports.today = function(timeseries, moment) {
...
exports.weekAgo = function(timeseries, offset, moment) {
  offset = offset || 0;
  ...
  var week1 = sumDays(timeseries, week1Start, week1End, moment);
  var week2 = sumDays(timeseries, week2Start, week2End, moment);
